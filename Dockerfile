...
ARG REDQUEENX_BUILD_COMMIT_DATE=unknown
ARG REDQUEENX_BUILD_COMMIT_SHA=unknown

ENV NODE_ENV=production \
  ADMIN_HOST=0.0.0.0 \
  PLAYWRIGHT_CHROMIUM_EXECUTABLE_PATH=/usr/bin/google-chrome-stable \
  PLAYWRIGHT_DISABLE_SANDBOX=false \
  REDQUEENX_BUILD_COMMIT_DATE=${REDQUEENX_BUILD_COMMIT_DATE} \
  REDQUEENX_BUILD_COMMIT_SHA=${REDQUEENX_BUILD_COMMIT_SHA}
